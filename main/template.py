...
def imagemap_message():
    message = ImagemapSendMessage(
        base_url="https://i.imgur.com/PnetoQB.jpg",
        alt_text='這個群組有誰呢',
        base_size=BaseSize(height=2000, width=2000),
        actions=[
            URIImagemapAction(
                #CHTommy0609 張辰宇
                link_uri="https://timeline.line.me/user/_ddwY7HexkXv3e4eOEmb6LVADRWKn5EwY7mTugA8?utm_medium=windows&utm_source=desktop&utm_campaign=Profile",
                area=ImagemapArea(
            ...
            URIImagemapAction(
                #Brian Hsu 許博程
                link_uri="https://timeline.line.me/user/_dfPSHYkAf0rkwqka-N2A-MiMGujExoNFS0pA6mo",
                area=ImagemapArea(
            ...
            URIImagemapAction(
                #wayne 陳禹安
                link_uri="https://timeline.line.me/user/_dTjoLFar-ieYpfXIYOPuXGjgp7tTrkfGIBFy5vc?utm_medium=windows&utm_source=desktop&utm_campaign=Profile",
                area=ImagemapArea(
            ...
            URIImagemapAction(
                #Oscar 陳品安  
                link_uri="https://timeline.line.me/user/_dS8XfHi54eZ0-P15Hq3TH2rnP4nrfI6x7972eug",
                area=ImagemapArea(
            ...
            URIImagemapAction(
                #climon稚家
                link_uri="https://timeline.line.me/user/_dTY2xy_MYJy1ZYSvHrN2bfJX28SN8S1e4wVuM88?utm_medium=windows&utm_source=desktop&utm_campaign=Profile",
                area=ImagemapArea(
